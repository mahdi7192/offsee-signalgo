App.service('signalGo', function () {
  ...
  */
  ...
  this.notifyOnOperatorSetUp = notifyOnOperatorSetUp;
  ...
  */
  ...
  function notifyOnOperatorSetUp(func) {
    this.observersOnOperatorSetUp.push(func);
  }
  ...
  function connectToServer(onSuccessCallback, onErrorCallback, onCloseCallback) {
    ...
    function () { // on success connect
      ...
      currentService.providerCallback.OnOperatorSetUp = function (serviceId, operatorId) {
        for (var i = 0; i < currentService.observersOnOperatorSetUp.length; i++) {
          currentService.observersOnOperatorSetUp[i](serviceId, operatorId);
        }
      }
  ...
  this.loginOperator = function (username, password, callback) {
    this.service.Send("LoginOperator", username, password, callback);
  }
  ...
  this.setServiceStepFromOperator = function (serviceId, step, callback) {
    this.service.Send("SetServiceStepFromOperator", serviceId, step, callback);
  }

  this.setServiceOperator = function (serviceId, callback) {
